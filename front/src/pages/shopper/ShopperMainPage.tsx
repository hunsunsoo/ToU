...
const ShopperMainPage = () => {
  ...
  const SlideToggleSlider = styled.img<{ viewEarth: boolean }>`
    ...
    border-radius: 50%;
    transition: 0.4s;
    transform: ${(props) => (props.viewEarth ? "translateX(30px)" : "translateX(0)")};
  `;
    ...
    <>
      <HeaderContainer>
        ...
        <SlideToggleLabel className="slide-toggle" viewEarth={viewEarth}>
          ...
          <SlideToggleSlider className="slider" viewEarth={viewEarth} src="/ToggleMap.png"></SlideToggleSlider>
        </SlideToggleLabel>
        <ShopperBtn
